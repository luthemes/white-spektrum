...
/*
============================================================================================================================
Backdrop - backdrop/backdrop.php
============================================================================================================================
This backdrop/backdrop.php uses an array_map(); feature that allows you add require file automatically without the need to 
...
============================================================================================================================
*/
namespace Backdrop\ThemeLayout;

/*
============================================================================================================================
Table of Content
============================================================================================================================
 1.0 - Theme Layout (Setup)
 2.0 - Theme Layout ($wp_customize)
 3.0 - Theme Layout (validation)
============================================================================================================================
*/
function theme_layout_selector_class() {
    class Control_Radio_Image extends \WP_Customize_Control {
        ...
        public function enqueue() {
            wp_enqueue_script('backdrop-customize-controls', get_theme_file_uri('/backdrop/dist/js/control-radio-image.js'), array('jquery'), '09012018', true);
            wp_enqueue_style('backdrop-customize-controls', get_theme_file_uri('/backdrop/dist/css/control-radio-image.css'), '09012018', true);
        }
...
add_action('customize_register', function($wp_customize) {
    ...
    /*
    ========================================================================================================================
    Enable and activate General Layouts for backdrop. The General Layout should only be used
    ...
    */    
    ...
    $wp_customize->add_setting('global_layout', array(
        ...
        'sanitize_callback' => 'Backdrop\ThemeLayout\sanitize_layouts',
        'transport'         => 'refresh',
        'type'              => 'theme_mod',
    ));
    ...
    $wp_customize->add_control(new Control_Radio_Image($wp_customize, 'global_layout', array(
        ...
        'type'          => 'radio-image',
        'choices'       => array(
			'left-sidebar'  => get_theme_file_uri('/backdrop/assets/images/2cl.png'),
            'right-sidebar' => get_theme_file_uri('/backdrop/assets/images/2cr.png'),
			'no-sidebar'    => get_theme_file_uri('/backdrop/assets/images/1col.png'),
        ),
    )));
});
