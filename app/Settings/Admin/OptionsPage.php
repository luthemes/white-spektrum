...
namespace WhiteSpektrum\Settings\Admin;

use Backdrop\Contracts\Bootable;
use WhiteSpektrum\Settings\Admin\Views;
	...
	public function template() { ?>
		...
		<div class="wrap">
			...
			<?php if ( current_user_can( 'customize' ) ) : ?>
				<a href="<?php esc_url( wp_customize_url() ) ?>" class="hide-if-no-js page-title-action"><?php esc_html_e( 'Customize', 'white-spektrum' ) ?></a>
			<?php endif ?>
