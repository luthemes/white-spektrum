<li id="comment-<?php comment_ID(); ?>" class="comments">
	...
	<header class="comment-meta">
		<?php Backdrop\Theme\Comment\display_parent_link( [
			...
			'text'   => __( 'In reply to %s', 'white-spektrum' ),
			'depth'  => 3,
		...
		?>
		<?php Backdrop\Theme\Comment\display_edit_link( [ 'before' => WhiteSpektrum\sep() ] ) ?>
		<?php Backdrop\Theme\Comment\display_reply_link( [ 'before' => WhiteSpektrum\sep() ] ) ?>
	</header>
	...
	<div class="comment-content">
		...
		<?php if ( ! Backdrop\Theme\Comment\is_approved() ) : ?>
			...
			<p class="comment-moderation">
				<?php esc_html_e( 'Your comment is awaiting moderation.', 'white-spektrum' ) ?>
			</p>
